...
void Init(void)
{
	...
	M(S8, 'z', S1, O4); M(S8, 'D', S1, O4); M(S8, 'E', S1, O4); M(S8, '9', S1, O4); M(S8, '<', S1, O4); M(S8, '>', S1, O4); M(S8, '=', S1, O4); M(S8, '"', S1, O4); M(S8, '(', S1, O4); M(S8, ')', S1, O4); M(S8, '[', S1, O4); M(S8, ']', S1, O4); M(S8, '{', S1, O4); M(S8, '}', S1, O4); M(S8, '.', S1, O4); M(S8, ',', S1, O4); M(S8, ':', S1, O4); M(S8, ';', S1, O4); M(S8, '+', S1, O4); M(S8, '-', S1, O4); M(S8, '*', S9, O27); M(S8, '/', S1, O4); M(S8, '#', S1, O4); M(S8, ' ', S1, O4);
	...
	M(S22, 'z', S1, O16); M(S22, 'D', S1, O16); M(S22, 'E', S1, O16); M(S22, '9', S1, O16); M(S22, '<', S1, O16); M(S22, '>', S1, O16); M(S22, '=', S1, O16); M(S22, '"', S1, O16); M(S22, '(', S1, O16); M(S22, ')', S1, O16); M(S22, '[', S1, O16); M(S22, ']', S1, O16); M(S22, '{', S1, O16); M(S22, '}', S1, O16); M(S22, '.', S1, O16); M(S22, ',', S1, O16); M(S22, ':', S1, O16); M(S22, ';', S1, O16); M(S22, '+', S1, O16); M(S22, '-', S1, O16); M(S22, '*', S1, O16); M(S22, '/', S1, O16); M(S22, '#', S1, O16); M(S22, ' ', S1, O16);
	M(S23, 'z', S1, O17); M(S23, 'D', S1, O17); M(S23, 'E', S1, O17); M(S23, '9', S1, O17); M(S23, '<', S1, O17); M(S23, '>', S1, O17); M(S23, '=', S1, O17); M(S23, '"', S1, O17); M(S23, '(', S1, O17); M(S23, ')', S1, O17); M(S23, '[', S1, O17); M(S23, ']', S1, O17); M(S23, '{', S1, O17); M(S23, '}', S1, O17); M(S23, '.', S1, O17); M(S23, ',', S1, O17); M(S23, ':', S1, O17); M(S23, ';', S1, O17); M(S23, '+', S1, O17); M(S23, '-', S1, O17); M(S23, '*', S1, O17); M(S23, '/', S1, O17); M(S23, '#', S1, O17); M(S23, ' ', S1, O17);
